...
<head>
<meta charset="UTF-8">
<!-- 부트스트랩 cdn - https://getbootstrap.com/docs/5.0/getting-started/download/ 의 CDN viajsDelivr 카피해서 씀 -->
...
<body>
	...
	<div class="container">
		...
		<form name="form1" method="post" action="${path}/member/insert.do">
			...
			<div class="form-group">
				주소 <br> <input class="form-control" style="width: 40%; display: inline;" placeholder="우편번호"
